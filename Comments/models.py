...
class Comments(models.Model):
    ...
    Comments_Creatorid = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='commentss1', on_delete=models.CASCADE)
    Comments_Helpfull= models.CharField(max_length=100)
    Comments_Creator = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='commentss2', on_delete=models.CASCADE)
