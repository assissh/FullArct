...
class Quick_RequirementsCreateView(LoginRequiredMixin, CreateView):
    ...
    fields = ['Quick_Requirements_Crew_Size',
              ...
              'Quick_Requirements_New_Requirement',
              'Quick_Requirements_Recipient',
              'Quick_Requirements_Requirement_Description',
              'Quick_Requirements_Shoot_Category',
              'Quick_Requirements_Shooting_Region',
              'Quick_Requirements_Tentative_Dates',
              'Quick_Requirements_Category',
              'Quick_Requirements_Pitch_List',
              'Quick_Requirements_Recipient',
              'Quick_Requirements_SUB_CATEGORY',]
...
class Quick_RequirementsUpdateView(LoginRequiredMixin, UpdateView):
    ...
    fields = ['Quick_Requirements_Crew_Size',
              'Quick_Requirements_From_User','Quick_Requirements_New_Requirement',
              'Quick_Requirements_Recipient','Quick_Requirements_Requirement_Description',
              'Quick_Requirements_Shoot_Category',
              'Quick_Requirements_Shooting_Region',
              'Quick_Requirements_Tentative_Dates',
              'Quick_Requirements_Category',
