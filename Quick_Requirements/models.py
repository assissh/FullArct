...
from location_pitch.models import LocationPitch
...
class Quick_Requirements(models.Model):
    Quick_Requirements_Category = models.ForeignKey(Location_Category,related_name='Quick_Requirements',on_delete=models.CASCADE)
    ...
    Quick_Requirements_Pitch_List = models.ForeignKey(LocationPitch,related_name='Quick_Requirements',on_delete=models.CASCADE)
    Quick_Requirements_Recipient = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE,null=True)
    ...
    Quick_Requirements_SUB_CATEGORY = models.ForeignKey(LocationSubCategory,related_name='Quick_Requirements', on_delete=models.CASCADE)
