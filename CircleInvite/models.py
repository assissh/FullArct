...
class CircleInvite(models.Model):
    ...
    CircleInvite_From = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='circleinvites1', on_delete=models.CASCADE)
    CircleInvite_To = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='circleinvites2', on_delete=models.CASCADE)
    CircleInvite_Creator = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='circleinvites3', on_delete=models.CASCADE)
    ...
    def __str__(self):
        return self.CircleInvite_Accepted
