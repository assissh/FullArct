...
class FilmLocationFromGuidedWithSerial(models.Model):
    ...
    FilmLocationFromGuidedWithSerial_Tourguide = models.ForeignKey(settings.AUTH_USER_MODEL,related_name='FilmLocationFromGuidedWithSerial',on_delete=models.CASCADE)
