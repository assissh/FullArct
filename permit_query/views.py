...
class PermitQueryCreateView(LoginRequiredMixin, CreateView):
    ...
    fields = ['PermitQuery_Address_Components',
              'PermitQuery_API_Address',
              'PermitQuery_City_State_Country',
              'PermitQuery_Latitude',
              'PermitQuery_Location',
              'PermitQuery_Longitude',
              'PermitQuery_Map_Address',
              'Permit_Query_Number',
              'PermitQuery_Query_Mode',
              'PermitQuery_Street_Address',
              'PermitQuery_List_Long_name',
              'PermitQuery_List_Short_Name',
              'PermitQuery_List_Type',]
