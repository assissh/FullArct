...
from help_category.models import Help_Category

# Create your helpcenters here.


class HelpCenter(models.Model):
    Helpcenter = models.ForeignKey(Help_Category , related_name='helpcenters', on_delete=models.CASCADE)
    Help_Center_Help_Name = models.CharField(max_length=100)
    Help_Center_Help_Id = models.IntegerField(default=0)
