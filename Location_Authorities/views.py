...
class Location_AuthoritisCreateView(LoginRequiredMixin, CreateView):
    ...
    fields = ['Location_Authority_Detail',
              'Location_Authority_Email',
              'Location_Authority_Google_Address',
              'Location_Authority_Latitude','Location_Authority_Longitude',
              'Location_Authority_Name','Location_Authority_Postal_Address',
              'Location_Authority_Contact_Number','Location_Authority_Contact_Name',
              'Location_Authority_Locality_City_State','Location_Authority_Location_ID',
              'Location_Authority_Office_Charges','Location_Authority_Street_Address',
              'Location_Authoritie_Contact_Officer']
...
class Location_AuthoritisUpdateView(LoginRequiredMixin, UpdateView):
    ...
    fields = ['Location_Authority_Detail','Location_Authority_Email',
              'Location_Authority_Google_Address','Location_Authority_Latitude',
    'Location_Authority_Name','Location_Authority_Postal_Address',
              'Location_Authority_Contact_Number','Location_Authority_Contact_Name',
              'Location_Authority_Locality_City_State','Location_Authority_Location_ID',
              'Location_Authority_Office_Charges','Location_Authority_Street_Address',
