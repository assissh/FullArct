...
class PlatformWorksCreateView(LoginRequiredMixin, CreateView):
    ...
    fields = ['PlatformWorks_Location_Manager','PlatformWorks_Client_Icon''PlatformWorks_Client_Name','PlatformWorks_Project_Name','Project_Image','PlatformWorks_Project_Details']
...
class PlatformWorksUpdateView(LoginRequiredMixin, UpdateView):
    ...
    fields = ['Project_Image','PlatformWorks_Client_Name',
              'PlatformWorks_Client_Icon','PlatformWorks_Project_Name','PlatformWorks_Project_Details']
