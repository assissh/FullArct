...
class LocationPitchCreateView(LoginRequiredMixin, CreateView):
    ...
    fields = ['LocationPitch_Message','LocationPitch_By_User','LocationPitch_Location_Required','LocationPitch_Submitted','LocationPitch_pitch_locationlist']
...
class LocationPitchUpdateView(LoginRequiredMixin, UpdateView):
    ...
    fields = ['LocationPitch_Message','LocationPitch_pitch_locationlist','LocationPitch_By_User','LocationPitch_Location_Required','LocationPitch_Submitted']
