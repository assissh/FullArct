...
class LocationPitch(models.Model):
    ...
    LocationPitch_pitch_locationlist = models.ForeignKey(Location, related_name='location_Pitchs', on_delete=models.CASCADE)
    ...
    location_pitch_Author = models.ForeignKey(settings.AUTH_USER_MODEL,related_name='location_pitchs_Author', on_delete=models.CASCADE)
