...
class OfficerContact(models.Model):
    # OfficerContact_Authority = models.ForeignKey(LocationAuthority,related_name='OfficerContact' ,on_delete=models.CASCADE)
    ...
    # OfficerContact_Officer = models.ForeignKey(District,related_name='OfficerContact' , on_delete=models.CASCADE)
