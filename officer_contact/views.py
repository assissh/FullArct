...
class OfficerContactCreateView(LoginRequiredMixin, CreateView):
    ...
    fields = ['OfficerContact_CONTACT_NUMBER',
              'OfficerContact_DEPARTMENT',
              'OfficerContact_DESIGNATIONS',
              'OfficerContact_E_Mail',
              'OfficerContact_Name',
              'OfficerContact_Authority',
              'OfficerContact_Officer']
