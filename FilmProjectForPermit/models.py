...
class FilmProjectForPermit(models.Model):
    FilmProjectForPermit_Cast = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='filmprojectforpermits_cast', on_delete=models.CASCADE)
    FilmProjectForPermit_Category = models.CharField(max_length=100)
    FilmProjectForPermit_Client = models.ForeignKey(settings.AUTH_USER_MODEL,related_name='FilmProjectForPermit_client',on_delete=models.CASCADE)
    ...
    FilmProjectForPermit_PermitLocationList = models.ForeignKey(Location, related_name='filmprojectforpermits', on_delete=models.CASCADE)
    FilmProjectForPermit_Project_Name = models.CharField(max_length=100)
    FilmProjectForPermit_ScriptasFile = models.FileField(upload_to = u'file/', max_length=200)
    FilmProjectForPermit_Synopsis = models.CharField(max_length=100)
    FilmProjectForPermit_Title = models.CharField(max_length=100)
    FilmProjectForPermit_Creator = models.ForeignKey(settings.AUTH_USER_MODEL ,related_name='filmprojectforpermits_Creator', on_delete=models.CASCADE)
