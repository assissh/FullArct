...
class MimicryArtist(models.Model):
    MimicryArtist_Comments = models.ForeignKey(Comments,related_name='MimicryArtist', on_delete=models.CASCADE)
    ...
    MimicryArtist_Portfolio = models.ForeignKey(PortfolioElement,related_name='MimicryArtist', on_delete=models.CASCADE)
    MimicryArtist_Portfolio_Projects = models.ForeignKey(ProfileProjects,related_name='MimicryArtist', on_delete=models.CASCADE)
    MimicryArtist_Rating = models.ForeignKey(Rating,related_name='MimicryArtist', on_delete=models.CASCADE)
    MimicryArtist_Video = models.ForeignKey(video,related_name='MimicryArtist', on_delete=models.CASCADE)
