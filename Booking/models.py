...
class Booking(models.Model):
    booking_from = models.ForeignKey(settings.AUTH_USER_MODEL,related_name='bookings', on_delete=models.CASCADE)
    ...
    creator = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='creator_bookings', on_delete=models.CASCADE)
