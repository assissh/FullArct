...
class theater_actorCreateView(LoginRequiredMixin, CreateView):
    ...
    fields = ['Body_Type','Daily_Charges','Description','Ethnicity','Favorite_Acting_Style',
              'Financial_Available','Height','Skin_Color','Special_Skills','Theater_Actor_ID',
              'Weight','theater_actor_Message','Comments','Portfolio','Ratings','Video']
...
class theater_actorUpdateView(LoginRequiredMixin, UpdateView):
    ...
    fields = ['Body_Type','Daily_Charges','Description','Ethnicity',
              'Favorite_Acting_Style','Financial_Available','Height',
              'Skin_Color','Special_Skills','Theater_Actor_ID','Weight','theater_actor_Message',
              'Comments', 'Portfolio', 'Ratings', 'Video']
