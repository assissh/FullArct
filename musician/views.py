...
class MusicianCreateView(LoginRequiredMixin, CreateView):
    ...
    fields = ['Musician_Comments',
              'Musician_Daily_Charges',
              'Musician_Description',
              'Musician_Financial_Available',
              'Musician_Genre',
              'Musician_Instrument',
              'Musician_ID',
              'Musician_Description_Portfolio',
              'Musician_Description_Profile_Projects',
              'Musician_Description_Ratings',
              'Musician_Description_Video',
              'musician_Message']
