...
class PropCreateView(LoginRequiredMixin, CreateView):
    ...
    fields = ['Prop_Color',
              'Prop_Daily_Rent',
              'Prop_Modification_Allowed',
              'Prop_Ownership_Status',
              'Prop_ID',
              'Prop_Make',
              'Prop_Type',
              'Prop_Weekly_Rent'
...
class PropUpdateView(LoginRequiredMixin, UpdateView):
    ...
    fields = ['Prop_Color','Prop_Daily_Rent','Prop_Images','Prop_Modification_Allowed','Prop_Ownership_Status','Prop_ID','Prop_Make','Prop_Type','Prop_Weekly_Rent']
