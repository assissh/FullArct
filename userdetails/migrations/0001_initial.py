    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Location_List', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='UserDetails', to='Location.Location')),
                ('Office_ID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='UserDetails', to='image.Image')),
                ('Ratings', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='UserDetails', to='Ratings.Rating')),
                ('Requirment_userdetailss', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='UserDetails2', to='Quick_Requirements.Quick_Requirements')),
                ('User_Email', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='UserDetails2', to=settings.AUTH_USER_MODEL)),
                ('userdetails_Author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='UserDetails', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='comment',
