...
class ActionVehicle(models.Model):
    ...
    ActionVehicle_image = models.ForeignKey(Image,related_name ='actionvechiles1',on_delete=models.CASCADE )
    ...
    ActionVehicle_ownership_proof =models.ForeignKey(Image, related_name='actionvechicles2', on_delete=models.CASCADE)
    ...
    ActionVehicle_creator =models.ForeignKey(settings.AUTH_USER_MODEL, related_name='actionvechicles', on_delete=models.CASCADE)
